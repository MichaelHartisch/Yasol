if (NOT HIGHS_ROOT_DIR)
    ...
    if(HIGHS_DIRS)
        ...
        foreach(HIGHS_DIR ${HIGHS_DIRS})
            ...
            if(NOT EXISTS "${HIGHS_ROOT_DIR}/src/Highs.h")
                continue()
            else()
    ...
    if(NOT EXISTS "${HIGHS_ROOT_DIR}/src")
        message(FATAL_ERROR "The provided HIGHS_ROOT_DIR does not seem to contain the folder 'src'. Maybe a typo?")
    endif()
endif()

message(STATUS "Looking for HIGHS include files in ${HIGHS_ROOT_DIR}/src and other paths")
find_path(HIGHS_INCLUDE_DIR
  NAMES Highs.h
  HINTS ${HIGHS_ROOT_DIR}/src
